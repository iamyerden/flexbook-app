...
export class BooksService {
  ...
  getBooksByGenre(genreGroup: string, genreName: string): Observable<any>{
    if (genreGroup){
      return this.http.get<any>(`${this.bookUrl}/genre?genreGroup=${genreGroup}&genreName=${genreName}`);
    }
